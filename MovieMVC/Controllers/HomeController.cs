...
namespace MovieMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var tiles = await DocumentDBRepository<Tile>.GetAllItemsAsync();
            return View(tiles);
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "TileId,TileDesc,EmployeeId,ReadUri,UpdateUri")] Tile tile)
        {
            if (ModelState.IsValid)
            {
                await DocumentDBRepository<Tile>.CreateItemAsync(tile);
